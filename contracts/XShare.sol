...
//         uint256 what = _xshare.mul(tshare.balanceOf(address(this))).div(
//             totalXShare
//         );
...
//     function tshareBalance(address _account)
//         external
//         view
//         returns (uint256 tshareAmount_)
//     {
//         uint256 xshareAmount = balanceOf(_account);
//         uint256 totalxshare = totalSupply();
//         tshareAmount_ = xshareAmount.mul(tshare.balanceOf(address(this))).div(
//             totalxshare
//         );
//     }

//     // returns how much tshare someone gets for redeeming xshare
//     function xshareForTShare(uint256 _xshareAmount)
//         external
//         view
//         returns (uint256 tshareAmount_)
//     {
//         uint256 totalxshare = totalSupply();
//         tshareAmount_ = _xshareAmount.mul(tshare.balanceOf(address(this))).div(
//             totalxshare
//         );
//     }

//     // returns how much xshare someone gets for depositing tshare
//     function tshareForxshare(uint256 _tshareAmount)
//         external
//         view
//         returns (uint256 xshareAmount_)
//     {
//         uint256 totaltshare = tshare.balanceOf(address(this));
//         uint256 totalxshare = totalSupply();
//         if (totalxshare == 0 || totaltshare == 0) {
