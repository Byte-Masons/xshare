...
contract ShareWrapper {
    ...
    // mint AMOUNT masonry tokens for the user, receive AMOUNT Tshares from him
...
contract Masonry is ShareWrapper, ContractGuard {
    ...
    /**
    This function we would use for the strategy when depositing funds (slightly before the end of an epoch, most likely as the last step)
     */
    ...
    /**
    This function we would use before depositing and therefore compounding (if users want to withdraw)
    Why does this call updateReward modifier twice ?
     */
    ...
    /**
    Basically a withdrawAllFunds, we should be able to ignore it
     */
    ...
    /**
    This function we would call if we do not need to withdraw (would that ever happen)
     */
    ...
    // probably reward distribution function
    // rewards aren't based on time as in other masterchef, but on epochs
    ...
    // we would not use this, nice function to save people who send random tokens to this contract
    // does not allow to save tomb or tshare wrongly sent to this contract
